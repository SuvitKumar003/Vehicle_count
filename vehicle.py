...
detect = []
offset=6 ##aloowable error between pixsels
counter=0
while True:
    ret, frame1 = cap.read()
    ...
    for (i,c) in enumerate(counterShape):
        ...
        validate_counter=(w>=min_width_rect) and (h>=min_height_react)
    ...
    cv2.putText(frame1," VEHICLE COUNTER : 0"+str(counter),(450,70),cv2.FONT_HERSHEY_SIMPLEX,2,(0,0,255),5)
